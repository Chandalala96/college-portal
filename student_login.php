...
<body>
   <div class="student-portal-title text-center">
    <h1>Student Login <span> <i class="fas fa-user-graduate"></i></span> </h1>
    </div>
    <section> 
        <div class="container text-center" id="login-form">
            <form class="login-form" method="post" action='./includes/login_includes.php'>
                <div class="mb-3 mt-3">
                <label class="login-label" for="u_id"><b>Student ID</b></label>
                <input type="text" class="form-control mx-auto" id="u_id" placeholder="Enter student ID" name="email" style="width: 100%;" required="">
              </div>
              <div class="mb-3">
